...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50">
        <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
            <img id="background" class="absolute -left-20 top-0 max-w-[877px]" src="https://laravel.com/{{asset('frontend/dpc')}}/{{asset('frontend/dpc')}}/assets/img/welcome/background.svg" />
                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    <img
                                        src="https://laravel.com/{{asset('frontend/dpc')}}/{{asset('frontend/dpc')}}/assets/img/welcome/docs-light.svg"
                                    ...
                                    />
                                    <img
                                        src="https://laravel.com/{{asset('frontend/dpc')}}/{{asset('frontend/dpc')}}/assets/img/welcome/docs-dark.svg"
                                        alt="Laravel documentation screenshot"
...
<head>
    ...
    <!-- Stylesheet -->
    <link rel="stylesheet" href="{{asset('frontend/dpc')}}/assets/css/vendor.css">
    <link rel="stylesheet" href="{{asset('frontend/dpc')}}/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="{{asset('frontend/dpc')}}/assets/css/style.css">
    <link rel="stylesheet" href="{{asset('frontend/dpc')}}/assets/css/responsive.css">
...
<body>
    ...
    <div class="navbar-area">
        <nav class="navbar navbar-expand-lg">
            <div class="container nav-container">
                <a class="main-logo" href="home.html"><img src="{{asset('frontend/dpc')}}/assets/img/logo.png" alt="img"></a>
            ...
            <div class="post-banner-slider owl-carousel">
                <div class="item">
                    <div class="top-post-wrap mb-0">
                        <div class="thumb">
                            ...
                            <img src="{{asset('frontend/dpc')}}/assets/img/banner/1.jpg" alt="img">
                        </div>
                        <div class="top-post-details">
                            ...
                            <div class="meta mt-2">
                                <div class="user">
                                    <div class="thumb">
                                        <img src="{{asset('frontend/dpc')}}/assets/img/banner/user.jpg" alt="img">
                                    </div>
                ...
                <div class="item">
                    <div class="top-post-wrap mb-0">
                        <div class="thumb">
                            <div class="overlay"></div>
                            <img src="{{asset('frontend/dpc')}}/assets/img/banner/2.jpg" alt="img">
                        </div>
                        <div class="top-post-details">
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="media-post-wrap">
                                <div class="thumb mb-4">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/business-people.jpg" alt="img">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap">
                                <div class="thumb mb-4">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/planning.jpg" alt="img">
                                </div>
                                <div class="media-body ms-0">
                                    <a class="tag top-right tag-purple" href="#">Marketing</a>
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap">
                                <div class="thumb mb-4">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/rich-man.jpg" alt="img">
                                </div>
                                <div class="media-body ms-0">
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap">
                                <div class="thumb mb-4">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/advertisement.jpg" alt="img">
                                </div>
                                <div class="media-body ms-0">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="media-post-wrap-3 media">
                        <div class="thumb">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/obama.jpg" alt="img">
                        </div>
                    ...
                    <div class="media-post-wrap-3 media">
                        <div class="thumb">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/parliament-img.jpg" alt="img">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media-post-wrap-3 media">
                        <div class="thumb">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/paper-thumb.jpg" alt="img">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media-post-wrap-3 media">
                        <div class="thumb">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/neon-light.jpg" alt="img">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="post-list-small-wrapper">
                        ...
                        <div class="post-grid-slider owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/1.jpg" alt="img">
                                </div>
                                <div class="details">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/2.png" alt="img">
                                </div>
                                <div class="details">
                                    <p>When working remotely and having to manage your own time, it is not uncommon for breaks to be overlooked.</p>
                                    <div class="meta d-flex">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/3.png" alt="img">
                                </div>
                                <div class="details">
                                    <p>When working remotely and having to manage your own time, it is not uncommon for breaks to be overlooked.</p>
                                    <div class="meta d-flex">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/4.png" alt="img">
                                </div>
                                <div class="details">
                                    <p>When working remotely and having to manage your own time, it is not uncommon for breaks to be overlooked.</p>
                                    <div class="meta d-flex">
    ...
    <div class="ad-area pd-bottom-40">
        <div class="container">
            <a class="w-100" href="#"><img src="{{asset('frontend/dpc')}}/assets/img/ad/kiante-ads.png" alt="img"></a>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="media-post-wrap mg-bottom-40">
                        <div class="thumb mb-4">
                            <img class="w-100" src="{{asset('frontend/dpc')}}/assets/img/blog/country-parliament.jpg" alt="img">
                        </div>
                        <div class="media-body ms-0">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="media-post-wrap-3 media">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/techboy.jpg" alt="img">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap-3 media">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/social-cut.png" alt="img">
                                </div>
                                <div class="media-body">
                                    <h6><a href="blog-category.html">The golden rules of midlife fitness and things getting wrong.</a></h6>
                                    <div class="meta d-flex">
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap-3 media">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/richman.png" alt="img">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="col-lg-6">
                            <div class="media-post-wrap-3 media">
                                <div class="thumb">
                                    <img src="{{asset('frontend/dpc')}}/assets/img/blog/business.png" alt="img">
                                </div>
                                <div class="media-body">
                    ...
                    <div class="video-area">
                        <div class="top-post-wrap">
                            <div class="thumb">
                                <img src="{{asset('frontend/dpc')}}/assets/img/blog/nature.jpg" alt="img" style="opacity: 1;">
                                <a class="video-play-btn" href="#" data-effect="mfp-zoom-in"><img src="{{asset('frontend/dpc')}}/assets/img/icon/play.png" alt="img"></a>
                            </div>
                            <div class="top-post-details">
                                <a class="tag top-right tag-green" href="#">Travel</a>
                                ...
                                <div class="meta mt-2">
                                    <div class="user">
                                        <div class="thumb">
                                            <img src="{{asset('frontend/dpc')}}/assets/img/banner/user.jpg" alt="img" style="opacity: 1;">
                                        </div>
                                        <a href="#">Stiven Jackson</a>
                                    </div>
                                    <div class="date">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="top-post-wrap mb-0">
                                    <div class="thumb">
                                        <img src="{{asset('frontend/dpc')}}/assets/img/blog/protest.jpg" alt="img" style="opacity: 1;">
                                        <a class="video-play-btn" href="#" data-effect="mfp-zoom-in"><img src="{{asset('frontend/dpc')}}/assets/img/icon/play.png" alt="img"></a>
                                    </div>
                                    <div class="top-post-details">
                                        <a class="tag top-right tag-purple" href="#">Politics</a>
                            ...
                            <div class="col-lg-6">
                                <div class="top-post-wrap mb-0">
                                    <div class="thumb">
                                        <img src="{{asset('frontend/dpc')}}/assets/img/blog/footballer.jpg" alt="img" style="opacity: 1;">
                                        <a class="video-play-btn" href="#" data-effect="mfp-zoom-in"><img src="{{asset('frontend/dpc')}}/assets/img/icon/play.png" alt="img"></a>
                                    </div>
                                    <div class="top-post-details">
                ...
                <div class="col-lg-4">
                    ...
                    <ul class="social-wrap">
                        <li class="ms-0"><a href="#"><img src="{{asset('frontend/dpc')}}/assets/img/icon/facebook.svg" alt="img"></a></li>
                        <li class="me-0"><a href="#"><img src="{{asset('frontend/dpc')}}/assets/img/icon/twitter.svg" alt="img"></a></li>
                        <li class="ms-0"><a href="#"><img src="{{asset('frontend/dpc')}}/assets/img/icon/instagram.svg" alt="img"></a></li>
                        <li class="me-0"><a href="#"><img src="{{asset('frontend/dpc')}}/assets/img/icon/pinterestsvg.svg" alt="img"></a></li>
                    </ul>
                    <div class="section-title pb-0">
                    ...
                    <div class="ad-area pd-top-90">
                        <a href="#">
                            <img src="{{asset('frontend/dpc')}}/assets/img/ad/add.png" alt="img">
                        </a>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="media-post-wrap">
                        <div class="thumb mb-4">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/social-1.png" alt="img">
                        </div>
                        <div class="media-body ms-0">
                            <a class="tag top-right tag-yellow" href="#">Technology</a>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="media-post-wrap">
                        <div class="thumb mb-4">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/playing-2.jpg" alt="img">
                        </div>
                        <div class="media-body ms-0">
                            <a class="tag top-right tag-blue" href="#">Sports</a>
                            <h4><a href="blog-category.html">The golden rules of midlife fitness and things getting wrong.</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="media-post-wrap">
                        <div class="thumb mb-4">
                            <img src="{{asset('frontend/dpc')}}/assets/img/blog/neon-light-1.jpg" alt="img">
                        </div>
                        <div class="media-body ms-0">
    ...
    <div class="container">
        <div class="subscribe-area" style="background-image: url({{asset('frontend/dpc')}}/assets/img/ad/Subscribe-Box.png);">
            <div class="row">
                <div class="col-lg-6">
    ...
    <!-- all plugins here -->
    <script src="{{asset('frontend/dpc')}}/assets/js/vendor.js"></script>
    <script src="{{asset('frontend/dpc')}}/assets/js/jquery.magnific-popup.min.js"></script>
    <!-- main js  -->
    <script src="{{asset('frontend/dpc')}}/assets/js/main.js"></script>
</body>
