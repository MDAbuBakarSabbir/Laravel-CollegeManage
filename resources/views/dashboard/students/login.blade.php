            ...
            <div class="col-xl-4 col-md-5">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        <div class="text-center w-75 mx-auto auth-{{asset('dashboard')}}/{{asset('dashboard')}}/assets/ mb-4">
                            <a class='{{asset('dashboard')}}/{{asset('dashboard')}}/assets/-dark' href='index.html'>
                                <span><img src="{{asset('dashboard')}}/assets/images/{{asset('dashboard')}}/{{asset('dashboard')}}/assets/-dark.png" alt="" height="22"></span>
                            </a>

                            <a class='{{asset('dashboard')}}/{{asset('dashboard')}}/assets/-light' href='index.html'>
                                <span><img src="{{asset('dashboard')}}/assets/images/{{asset('dashboard')}}/{{asset('dashboard')}}/assets/-light.png" alt="" height="22"></span>
                            </a>
                        </div>
