...
@section('content')
<x-breadcum title="Student Details"></x-breadcum>
                            ...
                            <form>
                                ...
                                <div class="row">
                                    <div class="mb-2 col-md-3">
                                        ...
                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Alternative Number">
                                    </div>
                                    <div class="mb-2 col-md-3">
                                        <label for="inputEmail4" class="form-label">Student Email Address</label>
                                        <input type="text" class="form-control" id="inputEmail4" placeholder="Student Email Address">
                                    </div>
                                    <div class="mb-2 col-md-3">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="mb-2">
                                    ...
                                    <input type="email" class="form-control" id="inputEmail4" placeholder="Occupation">
                                </div>
                                <div class="mb-2">
